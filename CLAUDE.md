...
- **Token-driven styling.** The prompt reads only these CSS custom properties, same names as @vdaluz/astro-blog: `--surface`, `--fg`, `--border`, `--accent`, `--on-accent`. Never hardcode site-specific colors beyond the dark fallbacks.
